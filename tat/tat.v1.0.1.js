(function() {
    ...
    QQTAT.lib = {
        ...
        "$Tips": {
            ...
            "show": function(sText, from) {
                ...
                this.eMask.style.backgroundImage = "url(c.png)";
    ...
    QQTAT.sWitch = {
        ...
        cursor: function(sSwitch, sIsLoading) {
            var sTatStyle = 'body{cursor:url(aero_arrow_xl.cur),auto !important}a{cursor:url(aero_link_xl.cur),auto !important}';
            var $Lib = QQTAT.lib;
            if (sSwitch) {
                if (sIsLoading) {
        ...
        "sound": function(txt) {
            ...
            if (QQTAT.lib.$Browser.mozilla || QQTAT.lib.$Browser.opera) {
                ...
                if (typeof FlashObject == "undefined") {
                    QQTAT.lib.$loadedJs("flash/swfobject.js", function() {
                        var so = new FlashObject("flash/QtPlayMp3.swf", "soundPlayer", "0", "0", "0", "#ffffff");
