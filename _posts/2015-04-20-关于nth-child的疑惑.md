...
{% include demo.html url="{{ page.url }}" html="1.html" css="2.css" %}
...
{% include demo.html url="{{ page.url }}" html="3.html" css="2.css" %}
...
{% include demo.html url="{{ page.url }}" html="4.html" css="1.css" %}
...
{% include demo.html url="{{ page.url }}" html="4.html" css="5.css" %}
