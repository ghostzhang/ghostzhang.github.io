...
2. 代码高亮​的实现方式也要改啦，只支持[Rouge](https://github.com/jneen/rouge)的方式。原先如果使用`{% raw %}{% highlight js %} code {% endhighlight %}{% endraw %}` 的方式进行代码高亮，那么就得修改啦，用` ``` `即可，详见  [https://help.github.com/articles/creating-and-highlighting-code-blocks/](https://help.github.com/articles/creating-and-highlighting-code-blocks/)。
